 ...
 */
final class Version20210630145513 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE order_item (id INT AUTO_INCREMENT NOT NULL, produit_id INT NOT NULL, order_ref_id INT DEFAULT NULL, quantity INT NOT NULL, INDEX IDX_52EA1F09F347EFB (produit_id), INDEX IDX_52EA1F09E238517C (order_ref_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
